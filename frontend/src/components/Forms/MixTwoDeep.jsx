...
import CompareTwoAlgoeithmDeep from "./CompareTwoAlgoeithmDeep";
...
const MixTwoDeep = ({ result1 }) => {
  ...
  return (
    <div>
      ...
      {result && finnish &&(
        <CompareTwoAlgoeithmDeep
          result1={result1}
          result2={result.error_values}
        />
      )}
    </div>
  );
};
MixTwoDeep.propTypes = {
