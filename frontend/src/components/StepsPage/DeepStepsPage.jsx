...
import UploadButtonDeep from "../UploadButton/UploadButtonDeep";
...
const steps = [
  ...
  {
    title: "İkinci Adım",
    content: () => <UploadButtonDeep />, // İkinci bileşen çağrısı
  },
  {
    title: "Son Adım",
        ...
        {current === steps.length - 1 && (
          <Link to="/">
            <Button
              type="primary"
              onClick={() =>
                message.success("Tekrar model eğitimi gerçekleştirebilirsiniz!")
              }
            >
              Tamamla
            </Button>
