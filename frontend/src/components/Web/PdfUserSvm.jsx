    ...
    if (!downloaded) {
      ...
      try {
        const response = await axios.post(
          "http://localhost:5000/generate_pdf_svm",
          {
        ...
        fetch("http://localhost:5000/add_reports_svm_data_adminpage", {
          method: "POST",
          headers: {
...
PdfUserSvm.propTypes = {
  ...
  companyiddValue: PropTypes.string,
};

export default PdfUserSvm;
