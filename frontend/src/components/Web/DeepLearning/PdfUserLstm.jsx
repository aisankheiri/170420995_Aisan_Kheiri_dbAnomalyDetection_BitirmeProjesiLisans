    ...
    if (!downloaded) {
      ...
      try {
        const response = await axios.post(
          "http://localhost:5000/generate_pdf_lstm",
          {
        ...
        fetch("http://localhost:5000/add_reports_lstm_data_adminpage", {
          method: "POST",
          headers: {
